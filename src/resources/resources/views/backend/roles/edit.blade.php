            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <select @if(!auth()->user()->can('edit_roles_permissions')) disabled @endif multiple class="form-control select2 @if ($errors->has('permissions')) is-invalid @endif" id="permissions" name="permissions[]">
                                    @foreach($permissions as $p_permission)
                                        <option value="{{ $p_permission->id }}" {{
                                            old('permissions') ? ((collect(old('permissions'))->contains($p_permission->id)) ? 'selected' : '') : (in_array($p_permission->id, $role->permissions->pluck('id')->toArray())) ? 'selected' : ''
